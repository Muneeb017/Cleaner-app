...
package com.muneeb.cleaner.plus.services
...
import com.muneeb.cleaner.plus.FileScanner
import com.muneeb.cleaner.plus.MainActivity.Companion.convertSize
...
class ScheduledService : JobIntentService() {
    public override fun onHandleWork(i: Intent) {
        try {
            ...
            val title =
                applicationContext.getString(R.string.service_notification_title) + " " + convertSize(
                    kilobytesTotal
                )
    ...
    companion object {
        ...
        fun makeStatusNotification(message: String?, context: Context) {
            val verboseNotificationChannelName =
                context.getString(R.string.settings_notification_name)
            val verboseNotificationChannelDescription =
            ...
            val channel =
                NotificationChannel(channelId, verboseNotificationChannelName, importance).apply {

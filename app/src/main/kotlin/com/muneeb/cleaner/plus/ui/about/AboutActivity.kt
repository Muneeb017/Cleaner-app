package com.muneeb.cleaner.plus.ui.about
...
import com.muneeb.cleaner.plus.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageViewAppIcon.setOnClickListener {
            openUrl("https://sites.google.com/view/muneeb7355608")
        }
        binding.chipGoogleDev.setOnClickListener {
            openUrl("https://developers.google.com/profile/u/MuneeB7355608")
        }
        binding.chipYoutube.setOnClickListener {
            openUrl("https://www.youtube.com/c/MuneeB7355608")
        }
        binding.chipGithub.setOnClickListener {
            openUrl("https://github.com/MuneeB7355608/${BuildConfig.APPLICATION_ID}")
        }
        binding.chipTwitter.setOnClickListener {
            openUrl("https://twitter.com/MuneeB7355608")
        }
        binding.chipXda.setOnClickListener {
            openUrl("https://forum.xda-developers.com/m/muneeb7355608.10095012")
        }
    }

...
package com.muneeb.cleaner.plus.ui.imageoptimizer
...
import com.muneeb.cleaner.plus.databinding.ActivityImageOptimizerBinding
        ...
        pickSingleMediaLauncher =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                if (result.resultCode != Activity.RESULT_OK) {
                    Toast.makeText(
                        this,
                        getString(R.string.failed_picking_media),
                        Toast.LENGTH_SHORT
                    ).show()
                } else {

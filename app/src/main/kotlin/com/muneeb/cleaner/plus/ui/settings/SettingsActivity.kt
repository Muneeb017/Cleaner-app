package com.muneeb.cleaner.plus.ui.settings
...
import com.muneeb.cleaner.plus.BuildConfig
import com.muneeb.cleaner.plus.receivers.CleanReceiver.Companion.cancelAlarm
import com.muneeb.cleaner.plus.receivers.CleanReceiver.Companion.scheduleAlarm
import com.muneeb.cleaner.plus.R
import com.muneeb.cleaner.plus.databinding.ActivitySettingsBinding
import com.muneeb.cleaner.plus.dialogs.RequireRestartDialog
...
class SettingsActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            val filterAggressivePreference =
                findPreference<SwitchPreferenceCompat>(getString(R.string.key_filter_aggressive))!!
            ...
            val dailyCleaner =
                findPreference<SwitchPreferenceCompat>(getString(R.string.key_daily_clean))
            ...
            val swapButtons =
                findPreference<SwitchPreferenceCompat>(getString(R.string.key_swap_buttons))
            ...
            moreApps?.setOnPreferenceClickListener {
                ...
                MaterialAlertDialogBuilder(requireContext())
                    ...
                    .create()
                    .show()
                val textViewAndroidStudioTutorials: MaterialTextView =
                    view.findViewById(R.id.text_view_android_studio_tutorials)
                val textViewMusicSleepTimer: MaterialTextView =
                    view.findViewById(R.id.text_view_music_sleep_timer)
                val textViewEnglishWithLidia: MaterialTextView =
                    view.findViewById(R.id.text_view_english_with_lidia)
                val textViewQRCodeScanner: MaterialTextView =
                    view.findViewById(R.id.text_view_qr_code_scanner)
                val textViewLowBrightness: MaterialTextView =
                    view.findViewById(R.id.text_view_low_brightness)
                val urls = mapOf(
                    textViewAndroidStudioTutorials to "https://play.google.com/store/apps/details?id=com.d4rk.androidtutorials",
                    textViewMusicSleepTimer to "https://play.google.com/store/apps/details?id=com.d4rk.musicsleeptimer.plus",
                    textViewEnglishWithLidia to "https://play.google.com/store/apps/details?id=com.d4rk.englishwithlidia.plus",
                    textViewQRCodeScanner to "https://play.google.com/store/apps/details?id=com.d4rk.qrcodescanner.plus",
                    textViewLowBrightness to "https://play.google.com/store/apps/details?id=com.d4rk.lowbrightness"
                )

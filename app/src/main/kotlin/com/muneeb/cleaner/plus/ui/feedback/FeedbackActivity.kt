package com.muneeb.cleaner.plus.ui.feedback
...
import com.muneeb.cleaner.plus.databinding.ActivityFeedbackBinding
...
class FeedbackActivity : AppCompatActivity() {
    ...
    private fun sendFeedbackEmail() {
        val emailIntent = Intent(Intent.ACTION_SEND).apply {
            type = "text/email"
            putExtra(Intent.EXTRA_EMAIL, arrayOf("muneeb7355608@gmail.com"))
